...
class InterfaceManagerClient:
    ...
    def _auto_detect_provider(self):
        ...
        # If application_url points to Groq cloud → GROQ provider
        if self.local_llm_base_url and "groq.com" in self.local_llm_base_url:
            self.logger.info("Detected GROQ provider via application_url")
            return "GROQ"
